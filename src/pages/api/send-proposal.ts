        ...
        <div style="background: white; border-radius: 0 0 12px 12px; padding: 28px;">
          ...
          <div style="background: #f9f9f7; border-radius: 10px; padding: 20px; margin-bottom: 24px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; font-size: 13px; color: #888;">Address</td><td style="padding: 8px 0; border-bottom: 1px solid #eee; font-size: 13px; color: #111; text-align: right;">${proposal.address}</td></tr>
              <tr><td style="padding: 8px 0; border-bottom: 1px solid #eee; font-size: 13px; color: #888;">System age</td><td style="padding: 8px 0; border-bottom: 1px solid #eee; font-size: 13px; color: #111; text-align: right;">${proposal.system_age}</td></tr>
              <tr><td style="padding: 8px 0; font-size: 13px; color: #888;">Diagnosis</td><td style="padding: 8px 0; font-size: 13px; color: #111; text-align: right;">${proposal.diagnosis}</td></tr>
            </table>
          </div>
          <div style="background: #f9f9f7; border-radius: 10px; padding: 20px; margin-bottom: 24px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ${addonsHtml}
              <tr><td style="padding: 12px 0 0; font-size: 16px; font-weight: 700; color: #111;">Total</td><td style="padding: 12px 0 0; font-size: 20px; font-weight: 800; color: #D85A30; text-align: right;">$${proposal.total_price?.toLocaleString()}</td></tr>
            </table>
          </div>
